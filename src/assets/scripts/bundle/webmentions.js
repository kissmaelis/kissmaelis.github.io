    ...
    responseJson.children.forEach((entry) => {
        ...
        if (!blocklist.includes(new URL(entry["wm-source"]).origin)) {
            ...
            if ((entry["wm-property"] == "like-of") || (entry["wm-property"] == "repost-of")) {
                ...
                webmention += "<a class=\"webmention--link no-indicator\" href=\"" + entry.url + "\" title=\"" + ((entry["wm-property"] == "repost-of") ? "Shared" : "Liked") + " by " + entry.author.name + "\">";
                ...
                if (entry.content && (entry.author.name != "")) {
                    ...
                    webmentionReply += "<a class=\"webmention webmention--link no-indicator\" href=\"" + entry.author.url + "\" title=\"" + ((entry["wm-property"] == "mention-of") ? "Mention" : "Reply") + " by " + entry.author.name + "\">";
                    ...
                    webmentionReply += "<a class=\"no-indicator\" href=\"" + entry.url + "\">View original mention</a>";
                    webmentionReply += "</div>";
                    webmentionReply += "</div>";
                    webmentionReply += "</li>";
