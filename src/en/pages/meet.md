...
To help streamline our communication, please include the following information in your message:
- your first name,
- your age,
- your postal code,
- your availability,
...
As this is not my primary occupation, I maintain a limited clientele and prioritize quality interactions. Same-day appointments are therefore rare.

I select my partners carefully, based on the trust you are able to inspire, your respect for me and my boundaries, your courtesy, and your adherence to my conditions. I have no criteria regarding age, origin, nationality, gender, or disability.

## Deposit
A deposit may be required in the following situations:
- for a longer session when we have not met before,
- if you invite me out of my city,
- or if a previous appointment has already been cancelled.

## Rescheduling and cancellations
Life can be full of unexpected turns. Please inform me as early as possible should you need to reschedule, so we can do so calmly and considerately.

Without prior notice, or in the absence of any communication, no future appointment will be accepted without a deposit.
